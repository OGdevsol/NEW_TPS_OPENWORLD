...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	private void ClampHorizontal()
	{
		...
		float acc = Mathf.Clamp(ControlFreak2.CF2Input.GetAxis("Mouse X"), -1, 1) * horizontalAimingSpeed;
		acc += Mathf.Clamp(ControlFreak2.CF2Input.GetAxis("Analog X"), -1, 1) * 60 * horizontalAimingSpeed * Time.deltaTime;
